...
def Demo():
  ...
  rdk_utils.Mols2FPs_RDK(mols, molWriter)
...
def DemoMorgan():
  ...
  for smi in rdk_utils.DEMOSMIS:
    ...
    mols.append(mol)
  molWriter = SmilesWriter("-", delimiter="\t", nameHeader='Name', includeHeader=True, isomericSmiles=True, kekuleSmiles=False)
  rdk_utils.Mols2FPs_Morgan(mols, 2, 1024, molWriter)
...
def DemoMACCSKeys():
  ...
  for smi in rdk_utils.DEMOSMIS:
    ...
    mols.append(mol)
  molWriter = SmilesWriter("-", delimiter="\t", nameHeader='Name', includeHeader=True, isomericSmiles=True, kekuleSmiles=False)
  rdk_utils.Mols2FPs_MACCSKeys(mols, molWriter)
...
if __name__ == "__main__":
  ...
  molReader = rdk_utils.File2Molreader(args.ifile, args.idelim, args.smicol-1, args.namcol-1, args.iheader)
  ...
  if args.op=="fpgen":
    ...
    rdk_utils.Mols2FPs_Morgan(mols, args.morgan_radius, args.morgan_nbits, molWriter)

  elif args.op=="fpgen_maccs":
    rdk_utils.Mols2FPs_MACCS(mols, molWriter)
